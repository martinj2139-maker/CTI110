# CTI110
P1LAB1 
[P1LAB1.ipynb](https://github.com/user-attachments/files/25472903/P1LAB1.ipynb)
{
 "cells": [
  {
   "cell_type": "markdown",
   "id": "b113e53c-1a5d-4afe-a45b-1029f0b2a4ea",
   "metadata": {},
   "source": [
    "# <strong>01 Pseudocode , Input and Output</strong>"
   ]
  },
  {
   "cell_type": "markdown",
   ...
   "metadata": {},
   "source": [
    "## <span style =\"color: blue\">What is pseudocode?</span>"
   ]
  },
  {
   "attachments": {},
  ...
  },
  {
   ...
   "metadata": {},
   "source": [
    "### <strong>How to add a comment (example)</strong>\n",
    " use # character"
   ]
  },
  {
  ...
  },
  {
   ...
   "metadata": {},
   "source": [
    "## <span style =\"color: blue\">Input , Processing and Output</span>"
   ]
  },
  {
   "attachments": {},
  ...
  },
  {
   ...
   "metadata": {},
   "source": [
    "## <span style =\"color: blue\"> print() </span>Function "
   ]
  },
  {
   "cell_type": "markdown",
  ...
  },
  {
   ...
   "metadata": {},
   "source": [
    "### <strong> Get input from user using</strong> <span style =\"color: blue\">input()</span><strong> Function</strong>\n",
  ...
  },
  {
   ...
   "metadata": {},
   "source": [
    "### Example using <span style=\"color:blue\">input()</span> function"
   ]
  },
  {
   "cell_type": "code",
   ...
   "source": [
    "name = input (\"Enter your name:\") # input function used to get user input and assign it to variable name\n",
    "print(\"Hello\", name, \"Welcome to CTI-110!\")\n",
    "last_name = input (\"Enter your last name:\")\n",
    "date = input (\"Enter today's date:\")\n",
    "assignment_name = input (\"Enter the assignment name:\")\n",
    "description_project = input (\"Enter a description of the project:\")\n"
   ]
  },
  {
   "cell_type": "code",
   ...
   "source": [
    ...
    "print(\"Hello\", Jeffrey, Martin, \"Welcome to CTI-110!\")\n",
    "date = input (\"Enter today's 2/22/2026:\")\n",
    "assignment_name = input (\"Enter the assignment name: P1LAB1\")\n",
    "description_project = input (\"Enter a description of the project: Writing code with Python in  Visual Studio Code\")\n"
   ]
  }
 ],
 "metadata": {
